...
//       const newBubbles = projects.map((project, index) => {
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    // Always regenerate bubbles when component mounts
    generateBubblePositions();

    // Optional: regenerate positions periodically to keep things interesting
    // const interval = setInterval(generateBubblePositions, 30000); // every 30 seconds
